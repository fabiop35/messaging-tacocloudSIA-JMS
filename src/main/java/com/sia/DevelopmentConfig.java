...
import com.sia.entities.Ingredient.Type;
import com.sia.entities.Taco;
import com.sia.entities.TacoOrder;
import com.sia.entities.User;
import com.sia.repositories.IngredientRepository;
import com.sia.repositories.OrderRepository;
import com.sia.repositories.TacoRepository;
import com.sia.repositories.UserRepository;
...
public class DevelopmentConfig {
    ...
    public CommandLineRunner dataLoader(IngredientRepository repo,
            ...
            OrderRepository orderRepo) { // user repo for ease of testing with a built-in user
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                userRepo.save(new User("anibal", encoder.encode("123"),
